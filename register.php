...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $sql = "INSERT INTO `tbl_user`(`user_name`, `user_email`, `user_password`, `user_number`) VALUES ('$name', '$email', '$password', '$phone')";
...
<body
    ...
    <div id="outer-wrap" class="site clr">
        ...
        <a class="skip-link screen-reader-text" href="login.php#main">Skip to content</a>
                        ...
                        <div class="e-con-inner">
                            <div class="elementor-element elementor-element-b79f874 elementor-widget elementor-widget-heading"
                                ...
                                <div class="elementor-widget-container">
                                    ...
                                    <h3 class="elementor-heading-title elementor-size-xl">Regsiter
                                    </h3>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="wpforms-container wpforms-container-full wpforms-render-modern"
                                                ...
                                                <form method="post">
                                                    ...
                                                    <div class="wpforms-field-container">
                                                        ...
                                                        <div id="wpforms-416-field_4-container"
                                                            class="wpforms-field wpforms-field-text" data-field-id="4">
                                                            <input type="password" id="wpforms-416-field_4"
                                                                class="wpforms-field-medium wpforms-field-required"
    ...
    <a aria-label="Scroll to the top of the page" href="login.php#" id="scroll-top" class="scroll-top-right"><i
        ...
        <div class="owp-qv-container">
            <div class="owp-qv-content-wrap">
                <div class="owp-qv-content-inner">
                    <a href="login.php#" class="owp-qv-close" aria-label="Close quick preview">×</a>
    ...
    <div id="oceanwp-cart-sidebar-wrap">
        <div class="oceanwp-cart-sidebar"><a href="login.php#" class="oceanwp-cart-close">×</a>
